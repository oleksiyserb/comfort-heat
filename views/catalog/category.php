...
<div class="container container__wrapper">
    ...
    <aside class="category">
        ...
        <div class="category__item">
            <a href="#" class="dropdown-btn <?php if ($category->id == $model->id) { echo 'visited'; } ?>"><?= $category->title; ?></a>
            <ul>

                <?php foreach ($category->subcategories as $subcategory): ?>
                <li><a href="<?= Url::to(['subcategory', 'id' => $subcategory->id]) ?>"><?= $subcategory->title; ?></a></li>
                <?php endforeach; ?>
        ...
        <section class="subcategory">
            ...
            <div class="subcategory__block">
                ...
                <div class="subcategory__item">
                    <a class="active" href="#">Усі категорії</a>
